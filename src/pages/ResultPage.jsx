...
核心理念：这是一套「关系」牌阵，解读必须紧扣客户问的具体问题和关系类型（爱情/友情/亲情）展开，而不是泛泛地讲牌义。投射牌揭示客户「把对方看成了谁」；三张细节牌像三面镜子，映照出客户自己在这段关系里真实的内在状态——情绪、念头、行为模式。投射出去的「对方形象」，往往正是客户自己内心未被看见的部分。语言要像朋友聊天，有温度、说到点子上。

牌阵：人际镜像阵（${spread.modeLabels[reading.mode]}）
解读方法：
- 投射牌（宫廷牌）= 客户把对方投射成了什么样的角色——在客户眼里，对方是什么性格、什么样的形象；
- 三张细节牌（小牌）= 三面镜子，分别从感受、想法、行动等侧面映照客户在这段关系里的真实内在状态。每张牌具体落在哪个侧面，由牌本身的花色与含义自然揭示，不必强行套固定维度。
请把投射牌与三张细节牌连起来解读，并始终回扣客户的具体问题，落在当下这段关系里说。

请按每张牌的顺序解读，紧密结合客户的具体问题展开。每段150-250字，温暖真诚。最后加一段「关系提示」：2-3句话总结客户在这段关系里最需要看见的内在真相。`
