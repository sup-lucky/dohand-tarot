...
核心理念：这是一套「关系」牌阵，解读必须紧扣客户问的具体问题和关系类型（爱情/友情/亲情）展开，而不是泛泛地讲牌义。投射牌揭示客户「把对方看成了谁」；三张细节牌像三面镜子，映照出客户自己在这段关系里真实的内在状态。投射出去的「对方形象」，往往正是客户自己内心未被看见的部分。语言要像朋友聊天，有温度、说到点子上。
